...
def plot_training_logs(log_path):
    ...
    # Создаем холст с тремя графиками
    fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(10, 12))
    
    # Сглаживание (скользящее среднее), чтобы графики были красивыми как в статьях
    window = 50 
    ...
    # 1. График Epsilon (Как падала случайность)
    ...
    # 3. График Вознаграждения (Самый важный!)
    ...
    # Сохраняем график в картинку для диплома
...
if __name__ == "__main__":
    # Укажи путь к логам нужного агента
